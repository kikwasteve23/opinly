...
export const COUNTRIES: CountryProfile[] = [
  ...
  { code: "ZA", name: "South Africa", currency: "ZAR", locale: "en-ZA", perUsd: 18.4, local: { id: "eft", name: "EFT bank transfer", steps: ["Open your South African banking app.", "Make an EFT for the ZAR amount shown.", "Use your Opinly email as the beneficiary reference.", "Confirm here once it is sent."] } },
