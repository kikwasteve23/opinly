    ...
    <div>
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
          ...
          <p className="mt-1 text-3xl font-bold">L{level}</p>
          <p className="mt-1 text-xs text-gray-500">
            {qualified} active referrals · {LEVEL_2_REFERRALS} needed for higher-paying studies
          </p>
        </div>
      </div>
      ...
      <div className="mt-10 flex items-end justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Level {level} is unlocked. Location {country.name} · pay shown in USD and {country.currency}.
          </p>
        </div>
              ...
              <div key={study.id} className="flex flex-col gap-3 rounded-2xl border border-gray-200 bg-white p-5 sm:flex-row sm:items-center dark:border-gray-800 dark:bg-gray-900">
                <div className="flex-1">
                  ...
                  <p className="mt-2 text-xs text-gray-500">
                    About {study.minutes} minutes · {study.format} · {formatMoney(study.reward, country)}
                  </p>
