    ...
    <div>
      ...
      <article className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        ...
        <div className="mt-10 space-y-6 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
          ...
          <p>Payout methods are USDT (TRC20), Litecoin, and country-local rails for the $50 wallet activation (credited to your available balance, not taken as a fee). Minimum withdrawal $500. You must be on referral level 2 (20 active referrals: approved people who finished a survey). Platform fee 5%. Network fees are passed through at cost. One withdrawal every 72 hours. After changing a payout address, withdrawals pause for 24 hours. Submissions auto-approve in 30–60 minutes when written answers have enough characters. Crypto sent to an address you supplied cannot be reversed.</p>
